    ...
    try {
      ...
      const updated = await pool.query(
        `UPDATE partner_venue_promotions SET
          ...
          discount_percent = CASE WHEN $13::boolean THEN $4 ELSE COALESCE($4, discount_percent) END,
          discount_amount = CASE WHEN $14::boolean THEN $5 ELSE COALESCE($5, discount_amount) END,
          time_from = CASE WHEN $15::boolean THEN $6 ELSE COALESCE($6, time_from) END,
          time_to = CASE WHEN $16::boolean THEN $7 ELSE COALESCE($7, time_to) END,
          starts_at = CASE WHEN $17::boolean THEN $8 ELSE COALESCE($8, starts_at) END,
          ends_at = CASE WHEN $18::boolean THEN $9 ELSE COALESCE($9, ends_at) END,
        ...
        [
          ...
          b.promoType ?? null,
          'discountPercent' in b ? (b.discountPercent ?? null) : null,
          'discountAmount' in b ? (b.discountAmount ?? null) : null,
          'timeFrom' in b ? (b.timeFrom || null) : null,
          'timeTo' in b ? (b.timeTo || null) : null,
          'startsAt' in b ? (b.startsAt || null) : null,
          'endsAt' in b ? (b.endsAt || null) : null,
          typeof b.isActive === 'boolean' ? b.isActive : null,
          typeof b.isFeatured === 'boolean' ? b.isFeatured : null,
          req.params.id,
          'discountPercent' in b,
          'discountAmount' in b,
          'timeFrom' in b,
          'timeTo' in b,
          'startsAt' in b,
