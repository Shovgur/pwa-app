...
import { ArrowUpRight, ArrowDownLeft, CreditCard, Send, Plus, RefreshCw } from 'lucide-react'

const TRANSACTIONS = [
  { id: 1, name: 'Оплата подписки', type: 'out', amount: -2990, date: '11 мар 2026', icon: '💳', color: '#f472b6' },
  { id: 2, name: 'Входящий платёж', type: 'in', amount: +15000, date: '10 мар 2026', icon: '💰', color: '#34d399' },
  { id: 3, name: 'Перевод команде', type: 'out', amount: -5500, date: '9 мар 2026', icon: '👥', color: '#f472b6' },
  { id: 4, name: 'Бонус за реферал', type: 'in', amount: +1200, date: '8 мар 2026', icon: '🎁', color: '#34d399' },
  { id: 5, name: 'Сервисы', type: 'out', amount: -890, date: '7 мар 2026', icon: '⚙️', color: '#f472b6' },
]
      ...
      >
        ...
        <div className="relative">
          ...
          <div className="flex items-center gap-1 mb-1">
            {[...Array(4)].map((_, i) => (
              <span key={i} className="text-white/80 font-mono text-lg tracking-widest">
                {i < 3 ? '•••• ' : '4821'}
              </span>
            ))}
          </div>
          ...
          {TRANSACTIONS.map((tx, i) => (
            ...
            >
              ...
              <div className="flex items-center gap-1.5">
                ...
                >
                  {tx.type === 'in' ? '+' : ''}{tx.amount.toLocaleString('ru')} ₽
                </span>
              </div>
            </motion.div>
          ))}
