...
// Псевдо-карта через CSS-сетку с маркером
  ...
  return (
    <div style={{ position: 'relative', width: '100%', height: 180, borderRadius: 16, overflow: 'hidden', background: '#1a2332' }}>
      ...
      <div style={{ position: 'absolute', left: '50%', top: '40%', transform: 'translate(-50%,-50%)' }}>
        ...
        >
          <div style={{
            background: court.color, color: '#fff', borderRadius: '50% 50% 50% 0', width: 36, height: 36,
        ...
        <AnimatePresence mode="wait">
            ...
            >
              ...
              <div style={{ position: 'relative', margin: '0 16px 16px', height: 200, borderRadius: 20, overflow: 'hidden' }}>
                ...
                <div style={{
                  ...
                  background: court.available ? 'rgba(34,197,94,0.85)' : 'rgba(239,68,68,0.85)',
                  ...
                  <div style={{ display: 'flex', gap: 8, flexWrap: 'wrap' }}>
                    {court.slots.slice(0, 4).map(slot => (
                      <div key={slot} style={{
                        ...
                        background: `${court.color}18`, color: court.color,
              ...
              {court.available && (
                <div style={{
                  ...
                  background: 'linear-gradient(transparent, #111827 30%)',
                }}>
                  <motion.button
                    ...
                    style={{
                      ...
                      boxShadow: `0 8px 24px ${court.color}50`,
                    }}
                  >
            ...
            >
              <div style={{ padding: '0 16px 100px' }}>
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: 12, marginBottom: 24 }}>
                  <button onClick={() => setStep('detail')} style={{ background: 'rgba(255,255,255,0.06)', border: 'none', borderRadius: 10, width: 36, height: 36, display: 'flex', alignItems: 'center', justifyContent: 'center', cursor: 'pointer' }}>
                ...
                <div style={{ marginBottom: 24 }}>
                  ...
                  <div style={{ display: 'flex', gap: 8, overflowX: 'auto', paddingBottom: 4 }}>
                    {UPCOMING_DATES.map(d => {
                      ...
                      return (
                        <button key={d.date} onClick={() => setSelectedDate(d)} style={{
                          flex: '0 0 auto', padding: '10px 14px', borderRadius: 14,
                          background: active ? court.color : 'rgba(255,255,255,0.05)',
                      ...
                      return (
                        <motion.button
                          ...
                          style={{
                            ...
                            background: active ? `${court.color}20` : 'rgba(255,255,255,0.04)',
                            border: active ? `1.5px solid ${court.color}` : '1px solid rgba(255,255,255,0.08)',
              ...
              <div style={{
                ...
                <motion.button
                  ...
                  style={{
                    width: '100%', padding: '16px', borderRadius: 16,
                    background: selectedSlot ? `linear-gradient(135deg, ${court.color}, ${court.color}bb)` : 'rgba(255,255,255,0.06)',
                    color: selectedSlot ? '#fff' : '#475569',
                    fontSize: 16, fontWeight: 700, border: 'none',
                    cursor: selectedSlot ? 'pointer' : 'default',
                    transition: 'all 0.2s',
                    boxShadow: selectedSlot ? `0 8px 24px ${court.color}50` : 'none',
                    display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 8,
                  }}
                >
            ...
            >
              <div style={{ padding: '0 16px 100px' }}>
                <div style={{ display: 'flex', alignItems: 'center', gap: 12, marginBottom: 28 }}>
                  <button onClick={() => setStep('booking')} style={{ background: 'rgba(255,255,255,0.06)', border: 'none', borderRadius: 10, width: 36, height: 36, display: 'flex', alignItems: 'center', justifyContent: 'center', cursor: 'pointer' }}>
                    <ChevronLeft size={18} color="#94a3b8" />
                  </button>
                  <div>
                ...
                <div style={{
                  ...
                  <div style={{
                    width: 60, height: 60, borderRadius: 14, background: court.photos[0],
              ...
              <div style={{ position: 'sticky', bottom: 0, padding: '12px 16px 24px', background: 'linear-gradient(transparent, #111827 30%)' }}>
                <motion.button
          ...
          {step === 'success' && (
            <motion.div
              ...
              style={{ padding: '20px 16px 48px', textAlign: 'center' }}
            >
              <motion.div
                initial={{ scale: 0 }}
                animate={{ scale: 1 }}
              ...
              <div style={{
                background: 'rgba(255,255,255,0.05)', borderRadius: 20, padding: 20, marginBottom: 24,
                border: `1px solid ${court.color}30`,
              }}>
